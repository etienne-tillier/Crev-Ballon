var data = fs.readFileSync('./resources/app/stockage/listeEtudiant.json'); //lecture du fichier de stockage et enregistrement des données dans data
var listEtudiant;
...
boutonSupp.addEventListener("click",function(event){
    ...
    fs.writeFile('./resources/app/stockage/listeEtudiant.json',data, function (err) { 
    if (err) 
