var data = fs.readFileSync('./resources/app/stockage/listeEtudiant.json');  //lecture du fichier de stockage et enregistrement de son contenu (chaine de caractere) dans data
...
buttonCreer.addEventListener('click',function(event){
    ...
    fs.writeFile('./resources/app/stockage/listeEtudiant.json',data, function (err) { //ecriture de la nouvelle liste de joueur (avec le nouveau) dans le fichier de stockage s'il n'y a pas d'erreurs
        if (err) 
